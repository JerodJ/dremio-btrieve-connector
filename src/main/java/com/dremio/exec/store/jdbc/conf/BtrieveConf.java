...
@SourceType(value = "BtrieveARP", label = "Btrieve",uiConfig = "btrieve-layout.json")
public class BtrieveConf extends AbstractArpConf<BtrieveConf> {
  private static final String ARP_FILENAME = "arp/implementation/btrieve-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.btrieve.BtrieveDriver";
